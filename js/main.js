...
let customScale = 1;
let targetFps = 60;
let bgmfile = './assets/audio/Guruguru Usagi.flac';
let bgmvolume = 0;
let bgm;
...
const AUDIO_DETAIL = [
	...
	},
	{
		...
		dialog: {
			...
			English: [
				"So, this is a pig...?",
				"Or maybe a hippo?...What?! A bird?! You're kidding!"
			],
			Chinese: [
				"话说，这个是猪？",
				"还是河马？诶？是鸟吗？骗人的吧！？"
...
const HITBOX = {
	headpat: { xMin: 650, xMax: 1310, yMin: -50, yMax: 400 },
	voiceline: { xMin: 300, xMax: 1400, yMin: 700, yMax: 1800 }
};
